...
// The data-slot attributes let stylesheets target card parts without every call
// site having to pass a class (see the workflow section styling in index.css).
