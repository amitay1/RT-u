...
import type { RtCrGeneralInfo, RtCrSource } from '@/types/rtCr';
...
export const RtCrEquipmentTab = ({ data, general, onChange }: Props) => {
  const set = <K extends keyof RtCrSource>(key: K, value: RtCrSource[K]) => (
