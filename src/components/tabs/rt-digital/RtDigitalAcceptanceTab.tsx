...
export const RtDigitalAcceptanceTab = ({ data, onChange }: Props) => {
  const set = <K extends keyof RtDigitalAcceptance>(k: K, v: RtDigitalAcceptance[K]) =>
    onChange({ ...data, [k]: v });
  ...
  return (
    <Card>
      ...
      <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <TextField label="Acceptance Standard" value={data.acceptanceStandard} onChange={v => set('acceptanceStandard', v)} placeholder="e.g. ASTM E2698" />
