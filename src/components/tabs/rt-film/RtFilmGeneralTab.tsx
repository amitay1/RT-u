...
interface Props {
  ...
  onChange: (d: RtFilmGeneralInfo) => void;
}

export const RtFilmGeneralTab = ({ data, onChange }: Props) => {
  const set = <K extends keyof RtFilmGeneralInfo>(k: K, v: RtFilmGeneralInfo[K]) =>
    onChange({ ...data, [k]: v });
  ...
  return (
    <Card>
      ...
      <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <TextField label="Material" value={data.material} onChange={v => set('material', v)} placeholder="e.g. Steel, Aluminum…" />
        <div className="grid grid-cols-[1fr_120px] gap-2">
          ...
          <SelectField
            ...
            onChange={v => set('thicknessUnit', v)}
